...
$pageBuilder = new PageBuilder(["title" => "Character Customizer"]);
$pageBuilder->addResource("polygonScripts", "/js/polygon/character.js");
			...
			<div class="template d-none">
				<div class="col-sm-3 col-6 mb-3 px-2">
					<div class="card hover">
						...
						<a href="$url"><img src="<?=Thumbnails::GetStatus("rendering")?>" data-src="$item_thumbnail" class="card-img-top img-fluid p-2" title="$item_name" alt="$item_name"></a>
						<div class="card-body p-2" style="line-height:normal">
							<p class="text-truncate text-primary m-0" title="$item_name"><a href="$url" style="color:inherit">$item_name</a></p>
						</div>
					</div>
				</div>
			</div>
