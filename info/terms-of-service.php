...
$pageBuilder = new PageBuilder(["title" => "Terms of Service and Rules"]);
$pageBuilder->buildHeader();
?>
<h2 class="font-weight-normal">Terms of Service and Rules</h2>
<p class="mb-1">By registering an account on <?=SITE_CONFIG["site"]["name"]?>, you must agree to the following:</p>
<ol class="mb-1">
	...
	<li><b>You may be held accountable if a user you invite to Project Polygon breaks the rules.</b> It will usually depend on the offence.</li>
</ol>
