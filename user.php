...
if(SESSION) 
{
	...
	pageBuilder::$JSdependencies[] = "/js/protocolcheck.js?t=".time();
...
<div class="row">
	<div class="col-md-6 p-0 left-bank divider-right">
		<div class="px-4 pb-4">
			...
			<div class="text-center"><p class="text-break"><?=Polygon::FilterText($info->blurb)?></p></div>
			<?php if(!$selfProfile) { ?>
	...
	<div class="col-md-6 p-0 right-bank">
		...
		<div class="games-container px-4 pb-4">
			...
			<div class="accordion-template d-none">
				<button class="accordion-header btn btn-light btn-block text-left mt-2 py-1"><i class="fas fa-angle-down accordion-arrow"></i> $server_name <span class="badge badge-secondary float-right mt-1">$version</span></button>
