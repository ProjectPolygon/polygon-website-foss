...
PageBuilder::$Config["title"] = "Inventory";
			  	...
			  	<div class="col-xl-2 col-lg-3 col-md-3 col-sm-4 col-6 pb-3 px-2">
					<a href="$url">
				  		<div class="card hover h-100">
				    		<img src="<?=Thumbnails::GetStatus("rendering")?>" data-src="$item_thumbnail" class="card-img-top img-fluid p-2" title="$item_name" alt="$item_name">
