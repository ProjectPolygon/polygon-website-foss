...
PageBuilder::$Config["title"] = "Give ".SITE_CONFIG["site"]["currency"];
...
<div class="row">
  <div class="col-lg-6 py-4 divider-right">
    ...
    <div class="row">
      <button class="btn btn-warning btn-block mx-3 text-light" data-control="giveCurrency"><span class="spinner-border spinner-border-sm" role="status" aria-hidden="true" style="display:none"></span> Give <?=SITE_CONFIG["site"]["currency"]?></button>
    </div>
  </div>
