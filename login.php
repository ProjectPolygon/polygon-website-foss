...
if($_SERVER['REQUEST_METHOD'] == 'POST')
{
	...
	else if (!$auth->VerifyPassword($userInfo->password)) $errors["password"] = "Incorrect password";
...
if($studio) PageBuilder::$Config["ShowNavbar"] = false;
PageBuilder::$Config["title"] = "Login";
