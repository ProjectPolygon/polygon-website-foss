...
<div class="row mb-2">
	<div class="col-sm-4">
		<?php if(SESSION && !$subforumInfo->minadminlevel || $subforumInfo->minadminlevel && SESSION && SESSION["adminLevel"] >= $subforumInfo->minadminlevel){ ?><a class="btn btn-primary" href="/forum/post?subforum=<?=$subforumInfo->id?>">New Thread</a><?php } ?>
	</div>
	<div class="col-sm-4">
...
<div class="table-responsive-xl">
	<table class="table table-hover">
		...
		<tbody>
			...
			<tr style="cursor:pointer;" onclick="window.location='/forum/thread?ID=<?=$thread->id?>'">
