...
PageBuilder::$Config['title'] = Polygon::FilterText($item->name).", ".vowel(Catalog::GetTypeByNum($item->type))." by ".$item->username;

PageBuilder::$Config["AppAttributes"]["data-asset-id"] = $item->id;
...
if(Users::IsAdmin()) PageBuilder::AddResource(PageBuilder::$PolygonScripts, "/js/polygon/admin/asset-moderation.js");
	...
	<div class="row">
		<div class="col-lg-4 col-md-6 col-sm-12 pb-3">
			...
			<div class="thumbnail-holder text-right" data-reset-enabled-every-page="" data-3d-thumbs-enabled="" data-url="<?=Thumbnails::GetAsset($item)?>">
				<span class="thumbnail-span mx-auto d-block" style="line-height:0;max-width:315px" data-3d-url="/asset-thumbnail-3d/json?assetId=<?=$item->id?>">
