...
if($_SERVER['REQUEST_METHOD'] == 'POST' && !$MaximumAccounts)
{
	...
	if(!$Errors->Username && !$Errors->Password && !$Errors->ConfirmPassword && !$Errors->RegistrationKey && !$Errors->ReCAPTCHA)
	{
		...
		copy(ROOT."/thumbs/avatars/32-420x420.png", Polygon::GetSharedResource("thumbs/avatars/$UserID-420x420.png"));

		Discord::SendToWebhook(["content" => "[".date('d/m/Y h:i:s A')."] **{$Fields->Username}** just joined! (ID {$UserID})"], Discord::WEBHOOK_POLYGON_JOINLOG, false);

		die(header("Location: /")); 
	}
}

PageBuilder::AddResource(PageBuilder::$Scripts, "https://www.google.com/recaptcha/api.js");
pageBuilder::$Config["title"] = "Welcome";
pageBuilder::buildHeader();
?>
<style>
	body
	{
		background: url(/img/landing/<?=rand(0,1)?'polygonwinter-edit':'polygonville-winter-edit'?>.jpg);
...
<div class="row mx-auto" style="max-width:31rem">
	<div class="col-3 pr-0">
		<img src="/img/PolygonChristmas.png" class="img-fluid">
	</div>
	<div class="col-9">
...
<div class="row">
	<div class="col-md-7 mt-5">
		...
		<div class="card bg-landing embed-responsive embed-responsive-16by9">
			<iframe class="embed-responsive-item" src="https://www.youtube.com/embed/<?=rand(0,1)?'u2cdM3DBaPA':'ZwBVaybEEHY'?>?version=3&controls=0&showinfo=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" autoplay allowfullscreen></iframe>
		</div>
