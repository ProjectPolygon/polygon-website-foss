...
<div class="row">
	<div class="col-lg-3 p-0 divider-right">
		<img src="<?=users::getUserAvatar(SESSION["userId"])?>" title="<?=SESSION["userName"]?>" alt="<?=SESSION["userName"]?>" width="180" height="220" class="mx-auto d-block">
	...
	<div class="col-lg-6 p-0 divider-right">
		<div class="polygon-news" style="display:none;">
			<div class="px-3 py-2">
				<h3 class="font-weight-normal pb-0"><?=SITE_CONFIG["site"]["name"]?> News</h3>
			</div>
			<div class="news-feed">
