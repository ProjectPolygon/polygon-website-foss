...
if (isset($_GET["UserID"]))
{
	...
	pageBuilder::$pageConfig["app-attributes"] .= " data-user-id=\"{$UserInfo->id}\"";
}
else if (isset($_GET["AssetID"]))
{
	...
	pageBuilder::$pageConfig["app-attributes"] .= " data-asset-id=\"{$AssetInfo->id}\"";
}
else
{
...
pageBuilder::$polygonScripts[] = "/js/polygon/admin/transactions.js?t=".time();
