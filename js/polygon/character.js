polygon.character = 
{
	...
	{
		$.get("/thumbs/rawavatar", { UserID: polygon.user.id, x: 420, y: 420 }, function(data) 
        {
            if (data == "PENDING") 
            {
	...
	render_avatar: function()
	{
		...
		$.post('/api/account/character/request-render', function(data)
		{ 
			$(".enable-three-dee").removeAttr("disabled");
