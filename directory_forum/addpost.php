...
if(!$threadInfo && $subforumInfo->minadminlevel && SESSION["user"]["adminlevel"] < $subforumInfo->minadminlevel){ PageBuilder::errorCode(404); }
...
PageBuilder::$Config["title"] = "New ".($threadInfo?"Reply":"Post");
PageBuilder::AddResource(PageBuilder::$Stylesheets, "/css/simplemde.min.css");
PageBuilder::AddResource(PageBuilder::$Scripts, "/js/simplemde.min.js");
